...
const CookiesPolicy = () => {
    return (
        <div className="policy-container">
            ...
            <h3 className="heading-tertiary">Advertising Cookies</h3>
            ...
            <h3 className="heading-tertiary">Analytics Cookies</h3>
            ...
            <h3 className="heading-tertiary">Our Cookies</h3>
            ...
            <h3 className="heading-tertiary">Personalization Cookies</h3>
            ...
            <h3 className="heading-tertiary">Security Cookies</h3>
            ...
            <h3 className="heading-tertiary">Site Management Cookies</h3>
            ...
            <h3 className="heading-tertiary">Third-Party Cookies</h3>
            ...
            <a href="https://support.google.com/chrome/answer/95647?co=GENIE.Platform%3DAndroid&hl=en&oco=1">Iphone or Ipad (Safari)</a>
        </div>
    )
}
